...
for i in range(300):
    ...
    azs = AZS(id=counter, sixdign=sixdign, ru=ru, num=num, hostname='AZS-'+str(ru)+'-'+str(num)+'-CRYPTO', user_added=randint(1,2), address='DIFFERENT_address-'+sixdign, dzo=randint(1,2), azs_type=randint(1,3), active=boole, mss_ip='10.1.1.'+str(randint(1,254)), need_to_check=True)
